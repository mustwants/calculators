      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            <a
              href="/"
              className="flex items-center space-x-3 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 rounded-md"
            >
              <img
                src="/brand/vetmover-logo.png"
                alt="VetMover by MustWants Logo"
              ...
              <div>
                ...
                <p className="text-blue-200 text-xs">
                  Military Real Estate &amp; VA Loan Calculators
                </p>
              </div>
            </a>
          </div>
          ...
          >
            ...
            <a
              href="https://mustwants.com/about"
              target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
          <div className="flex items-center justify-center space-x-6 text-sm text-blue-200">
            <span className="flex items-center space-x-1">
              ...
              <span>
                SDVOSB Certified • Veteran Owned • Serving Military Families
              </span>
            </span>
            ...
            <span className="hidden sm:flex items-center space-x-1">
              ...
              <span>
                PCS Moves • BAH Analysis • VA Loans • Military Real Estate
              </span>
            </span>
          </div>
        </div>
